...
export const COMMUNICATION_CATALOG_ID = "communication-catalog/gc5-s13";
...
/** GC5-S13. Last public trade notice drops after this many committed cycles. */
export const TRADE_NOTICE_EXPIRE_AFTER_CYCLES = 1;
