...
export const CONSTRUCTION_CATALOG_ID = "construction-catalog/gc2-s14";
...
export const MULTI_CYCLE_CLASSES: readonly ConstructibleClass[] = ["relay", "workshop", "generator"];
