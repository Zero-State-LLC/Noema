...
export const CONSTRUCTION_CATALOG_ID = "construction-catalog/gc2-s21";
...
export const MULTI_CYCLE_CLASSES: readonly ConstructibleClass[] = [
  "relay",
  "workshop",
  "generator",
  "storage_bay",
...
/** GC2-S21. Owner plus three co-owners. Fourth-and-later stay closed. */
export const SHARE_MAX_CO_OWNERS = 3;
