...
export const CONSTRUCTION_CATALOG_ID = "construction-catalog/gc2-s22";
...
/** GC2-S22. Owner plus four co-owners. Fifth-and-later stay closed. */
export const SHARE_MAX_CO_OWNERS = 4;
