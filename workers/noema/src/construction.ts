...
export const CONSTRUCTION_CATALOG_ID = "construction-catalog/gc2-s23";
...
/** GC2-S23. Owner plus five co-owners. Sixth-and-later stay closed. */
export const SHARE_MAX_CO_OWNERS = 5;
