  ...
  async function load() {
    ...
    try {
      ...
      kv($("kv-world"), [
        ...
        ["state_json sequence", data.canonical_head ? data.canonical_head.state_json_sequence : "—"],
        ["DO sequence", data.canonical_head ? data.canonical_head.do_sequence : "—"],
        ...
        ["DO ≠ head", data.canonical_head && data.canonical_head.do_ne_head ? "yes" : "no"],
        ["head ≠ state_json", data.canonical_head && data.canonical_head.head_ne_state_json ? "yes" : "no"],
