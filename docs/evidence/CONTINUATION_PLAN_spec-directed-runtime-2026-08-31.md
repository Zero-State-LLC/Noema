...
| C2 | PARTIAL / CI_GREEN | Runtime PR CI now runs Worker and Python regression ([#635](https://github.com/Zero-State-LLC/Noema/pull/635), closed #632). Main CI is green on the deploy source after [#638](https://github.com/Zero-State-LLC/Noema/pull/638) ([run 34167567879](https://github.com/Zero-State-LLC/Noema/actions/runs/34167567879) on `9c25603581992da0440b2dd733a554aca98adef0`) and remains green through pin [#639](https://github.com/Zero-State-LLC/Noema/pull/639) and baseline [#640](https://github.com/Zero-State-LLC/Noema/pull/640). A full local candidate suite (Worker + typecheck + integration + official-client path) may still be required for P2. Specs CI defect [#324](https://github.com/Zero-State-LLC/Noema-Specs/issues/324) remains open. |
