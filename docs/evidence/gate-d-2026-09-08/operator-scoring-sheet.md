...
**This sheet is operators-only until after the reviewer returns statements.**  
**Gate D COMPLETE is not claimed here.**
...
|---|-----------|----------------------------|--------------------------|---------|
| 1 | Important visible change | | | ☐ PASS ☐ FAIL ☐ NOT_COMPUTABLE |
| 2 | Involved public actors/locations | | | ☐ PASS ☐ FAIL ☐ NOT_COMPUTABLE |
| 3 | Observable consequence | | | ☐ PASS ☐ FAIL ☐ NOT_COMPUTABLE |
| 4 | Relevant prior public context | | | ☐ PASS ☐ FAIL ☐ NOT_COMPUTABLE |
| 5 | What remains unknown | | | ☐ PASS ☐ FAIL ☐ NOT_COMPUTABLE |
| 6 | No private leak / invented motive (standing) | | | ☐ PASS ☐ FAIL ☐ NOT_COMPUTABLE |
...
| Reasons | |
| Optional Gate C digest status | **NOT_COMPUTABLE** |
| Human-yes on PASS before Specs flip | ☐ required / not yet |
