...
**Freeze.** `docs/HOSTED-ALPHA-FREEZE.md` · pin `8a93770` · Worker `77130fe1-9b9c-4733-9ce1-82ce758160be`  
...
Frozen surfaces are locked by `spec-compat.json` `frozen_release` and `workers/noema/test/hosted-alpha-freeze.test.ts`. Later work that changes admission, seal, Genesis, verbs, or room bound must `UNFREEZE` in the same PR. Freeze name `hosted-alpha-0.12.1` pins deployed runtime `8a93770` / Worker `77130fe1`.
